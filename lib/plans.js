...
function voiceAllowed(account, owner = false) {
  ...
  if (!u.voice.included) return { ok: false, reason: `The ${u.tierName} plan doesn't include phone calls — Front Desk ($${TIERS.frontdesk.price}/mo) adds the AI phone agent.` };
