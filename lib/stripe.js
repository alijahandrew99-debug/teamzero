...
function hasAccess(account) {
  ...
  return plans.usage(account, false).remaining > 0;
}
...
module.exports = { configured, configReport, hasAccess, createPortal, isPaid, isOwner, createCheckout, verifyWebhook, applyEvent };
