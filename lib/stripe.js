...
async function createMissingPrices() {
  ...
  for (const t of plans.tierList()) {
    if (plans.priceIdForTier(t.id)) { skipped.push(t.id); continue; }
...
module.exports = { configured, configReport, hasAccess, canSpend, createPortal, isPaid, isOwner, createCheckout, createMissingPrices, verifyWebhook, applyEvent, inGrace, reconcileCheckout, DUNNING };
