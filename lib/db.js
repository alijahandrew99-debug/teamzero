// TeamZero Cloud data layer — account-scoped JSON store, zero dependencies.
...
module.exports = {
  ...
  getProfiles, allProfiles, getProfile, createProfile, updateProfile,
  getLeads, addLeads, updateLead,
