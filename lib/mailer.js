// System mailer — the emails TeamZero itself sends (password resets, the morning
...
function cfg() {
  return {
    ...
    fromName: process.env.SYSTEM_SMTP_FROM_NAME || 'TeamZero',
  };
}
...
async function sendPasswordReset(to, token) {
  ...
  return send(to, 'Reset your TeamZero password', [
    'Someone asked to reset the password for your TeamZero account.',
    '',
