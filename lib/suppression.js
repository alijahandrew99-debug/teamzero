...
function isHardBounce(errMessage) {
  ...
  return /\b5(50|51|53|60|),?\b|\b55[0-9]\b|user unknown|no such user|does not exist|address rejected|recipient rejected|invalid recipient|mailbox unavailable|account (has been )?disabled/i.test(m);
}
